# ruff: noqa: I001
# an arcgis script tool wrapping `changedetector diff` CLI
import os
...
def changedetector():
    param = {
        ...
        "hash_fields": arcpy.GetParameter(4),
        "fields": arcpy.GetParameter(5),
        "ignore_fields": arcpy.GetParameter(6),
        "precision": arcpy.GetParameter(7),
        "hash_key": arcpy.GetParameter(8),
    ...
    stem = changedetector_common.build_output_stem(
        param["out_name"], "changedetector_diff"
    )
