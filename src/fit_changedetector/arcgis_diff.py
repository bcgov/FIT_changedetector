...
def changedetector():
    ...
    # arcgis messages panel via run_tool/run_cli) - out_folder here is only
    # used for the run's log file
    ...
    cli_args = build_cli_args(param)
    arcgis_common.run_tool("diff", param, logfile, cli_args)
